  ...
  handleLikeClick(clickEvent) {
    ...
    if (clickEvent.button === 0) {
      ...
      if (this.didUserLike()) {
        ...
        unlikeComment(this.state.id, this.state.parent, 4, callbackFunction);
      } else {
        // User clicked 'like' button.
        likeComment(this.state.id, this.state.parent, 4, callbackFunction);
      }
    }
  }
    ...
    return (
      <div>
        ...
        <div className="media-body">
          ...
          <br /> 
            <a href="#" onClick={(e) => this.handleLikeClick(e)}>{likeButtonText}</a> · <a href="#">Reply</a> · {unixTimeToString(this.props.postdate)}
        </div>
      </div>
    )
  }
