...
import CommentThread from './commenthread';
        ...
        <div className="panel-footer">
          ...
          <CommentThread onPost={(commentText) => this.handleCommentPost(commentText)}>
            ...
            data.comments.map((comment, i) => {
              ...
              return (
                <Comment author={comment.author} postDate={comment.postDate} likeCounter = {comment.likeCounter} parent={this.state._id} id={i} key = {i}>
                  {comment.contents}
                </Comment>
              );
            })
